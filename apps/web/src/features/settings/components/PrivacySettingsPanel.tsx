    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="rounded-xl bg-blue-50 border border-blue-100 px-4 py-4">
          <p className="text-sm text-blue-800 font-medium mb-1">{t('privacy.infoBanner.title')}</p>
          <p className="text-xs text-blue-700 leading-relaxed">
            {t('privacy.infoBanner.body')}
          </p>
        </div>
        ...
        <div className="flex items-start gap-4 rounded-xl border border-gray-100 bg-gray-50/50 px-4 py-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-gray-800">{t('privacy.exportData.title')}</p>
          ...
          >
            ...
            {requested ? t('privacy.exportData.requested') : t('privacy.exportData.button')}
          </Button>
        </div>
