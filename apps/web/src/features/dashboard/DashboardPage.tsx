...
function DashboardSkeleton() {
  return (
    <div className="space-y-6" aria-busy="true" aria-label="Loading dashboard">
      <div className="h-28 rounded-2xl bg-blue-200 animate-pulse opacity-60" />
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {[0, 1, 2, 3].map((n) => (
          <div key={n} className="h-24 rounded-2xl bg-gray-100 animate-pulse" />
        ))}
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <div className="lg:col-span-2 h-44 rounded-2xl bg-gray-100 animate-pulse" />
        <div className="lg:col-span-3 h-44 rounded-2xl bg-gray-100 animate-pulse" />
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <div className="lg:col-span-2 h-60 rounded-2xl bg-gray-100 animate-pulse" />
        <div className="lg:col-span-3 h-60 rounded-2xl bg-gray-100 animate-pulse" />
      </div>
    </div>
  )
}
